...
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd(programs.wswitcher))
...
-- Optional power button script for Tablet/Detachable/2-in-1 devices to behave like a normal tablet
-- local function power_btn()
--     local dpmsState = hl.get_active_monitor().dpms_status
--     if dpmsState == true then
...
--     end
-- end
-- hl.bind("XF86PowerOff", power_btn, { locked = true })
